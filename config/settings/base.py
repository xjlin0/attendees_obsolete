...
)  # (attendees/config/settings/base.py - 3 = attendees/)
APPS_DIR = ROOT_DIR.path("attendees")
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="mysql://root:@127.0.0.1:3307/attendees")
    # "default": env.db("DATABASE_URL", default="postgres:///attendees")
}
